...
@section('content')
<div class="min-h-screen bg-[#F9FAFB] flex items-start justify-center py-20 px-6">
    <div class="w-full max-w-xl">
        <div class="text-center mb-10">
            <h1 class="text-3xl font-bold tracking-tight text-[#111827]">Daftar GoMad</h1>
        ...
        <div class="border border-[#E5E7EB] rounded-[12px] p-8 bg-white shadow-gomad" x-data="{ 
            step: 1,
            role: 'customer',
            showPassword: false,
            showConfirm: false,
            ...
            <div x-show="step === 1" class="space-y-4">
                ...
                <button @click="selectRole('customer')"
                        class="w-full flex items-center gap-4 p-5 border border-[#E5E7EB] rounded-[12px] hover:border-[#BA1826] transition group text-left bg-white">
                    <div class="w-12 h-12 bg-[#F9FAFB] rounded-[10px] flex items-center justify-center text-xl group-hover:bg-[#BA1826]/10 transition flex-shrink-0">
                        <svg class="w-6 h-6 text-[#111827]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    </div>
                    <div class="flex-1 min-w-0">
                        <h3 class="font-bold text-[#111827]">Customer</h3>
                        <p class="text-sm text-gray-500 truncate font-light">Booking travel, cari jadwal, bayar online atau di warung</p>
                    </div>
                    <svg class="w-5 h-5 text-gray-300 group-hover:text-[#BA1826] transition flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                </button>
                ...
                <button @click="selectRole('agency')"
                        class="w-full flex items-center gap-4 p-5 border border-[#E5E7EB] rounded-[12px] hover:border-[#BA1826] transition group text-left bg-white">
                    <div class="w-12 h-12 bg-[#F9FAFB] rounded-[10px] flex items-center justify-center text-xl group-hover:bg-[#BA1826]/10 transition flex-shrink-0">
                        <svg class="w-6 h-6 text-[#111827]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    </div>
                    <div class="flex-1 min-w-0">
                        <h3 class="font-bold text-[#111827]">Agency</h3>
                ...
                <button @click="selectRole('payment_agent')"
                        class="w-full flex items-center gap-4 p-5 border border-[#E5E7EB] rounded-[12px] hover:border-[#BA1826] transition group text-left bg-white">
                    <div class="w-12 h-12 bg-[#F9FAFB] rounded-[10px] flex items-center justify-center text-xl group-hover:bg-[#BA1826]/10 transition flex-shrink-0">
                        <svg class="w-6 h-6 text-[#111827]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 100 4 2 2 0 000-4z"/></svg>
                    </div>
                    <div class="flex-1 min-w-0">
                        <h3 class="font-bold text-[#111827]">Warung GoMad</h3>
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-gray-500">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="text-[#BA1826] font-semibold hover:underline">Masuk di sini</a>
                    </p>
                </div>
            </div>
            ...
            <div x-show="step === 2">
                {{-- Back Button --}}
                <button @click="backToStep1()" class="text-sm text-gray-400 hover:text-[#BA1826] mb-6 flex items-center gap-1 transition">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="space-y-5">
                        ...
                        {{-- Email --}}
                        <div>
                            <label class="block text-xs font-mono uppercase tracking-wider text-gray-500 mb-1">Alamat Email <span class="text-[#BA1826]">*</span></label>
                        ...
                        {{-- Password --}}
                        <div>
                            <label class="block text-xs font-mono uppercase tracking-wider text-gray-500 mb-1">Password <span class="text-[#BA1826]">*</span></label>
                            <div class="relative">
                            ...
                            <div class="mt-2" x-show="password.length > 0">
                                ...
                                <div class="bg-[#E5E7EB] rounded-full h-1.5 overflow-hidden">
                        ...
                        {{-- Konfirmasi Password --}}
                        <div>
                            <label class="block text-xs font-mono uppercase tracking-wider text-gray-500 mb-1">Konfirmasi Password <span class="text-[#BA1826]">*</span></label>
                            <div class="relative">
                                <input :type="showConfirm ? 'text' : 'password'" name="password_confirmation"
                                       class="w-full px-0 py-2 pr-8 border-b-2 border-[#E5E7EB] focus:border-[#BA1826] outline-none bg-transparent text-[#111827] transition"
                                       placeholder="Ulangi password" required>
                                <button type="button" @click="showConfirm = !showConfirm" class="absolute right-0 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#111827] transition-colors">
                        ...
                        <div x-show="role === 'customer'" x-cloak>
                            ...
                            <input type="text" name="referral_code" value="{{ old('referral_code', request('ref')) }}"
                                   class="w-full px-0 py-2 border-b-2 border-[#E5E7EB] focus:border-[#BA1826] outline-none bg-transparent text-[#111827] uppercase transition"
