...
@php
    ...
    $uniqueId = 'promo_' . md5(json_encode($promoData));
@endphp
...
<section class="section container-magazine" 
    ...
    <div x-show="loading" x-cloak>
        ...
        <div class="relative max-w-3xl mx-auto">
            <div class="bg-white border border-[#E5E7EB] rounded-[12px] shadow-gomad animate-pulse" style="height: 420px;">
    ...
    <div x-show="!loading" x-cloak>
        <div class="flex items-center justify-between mb-12">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-3xl font-bold tracking-tight text-[#111827]">Promo Spesial</h2>
            </div>
            
            <div class="flex items-center gap-2">
                <button @click="prevPromo()" 
                        class="w-10 h-10 rounded-full border border-[#E5E7EB] hover:border-[#BA1826] hover:bg-[#BA1826]/5 transition flex items-center justify-center text-[#111827] hover:text-[#BA1826]"
                ...
                <div class="flex gap-1.5 ml-3">
                    <template x-for="(_, index) in promoItems" :key="index">
                        <button @click="goToPromo(index)" 
                                ...
                                :class="currentPromoIndex === index ? 'w-8 bg-[#BA1826]' : 'bg-[#D1D5DB] hover:bg-[#9CA3AF]'"
        ...
        <div class="relative max-w-3xl mx-auto">
            <div class="relative overflow-hidden rounded-[12px] bg-white border border-[#E5E7EB] shadow-gomad" style="height: 420px;">
                                ...
                                <div class="relative w-full h-full">
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 p-8 text-white">
                                        <div class="flex items-center gap-2 mb-3">
                                            <span class="px-3 py-1 rounded-full text-[10px] font-mono uppercase tracking-wider border border-white/30"
                                            ...
                                            <span x-show="promo.type === 'selective'" 
                                                  class="px-3 py-1 rounded-full text-[10px] font-mono uppercase tracking-wider bg-purple-500/70 border border-white/30">
                                                Selektif
                                            </span>
                                            <span class="ml-auto bg-[#BA1826] text-white px-4 py-1.5 rounded-full text-sm font-bold shadow-lg"
                                                  x-text="promo.discount_text">
                                            </span>
                                        </div>
                                        <h3 class="text-2xl md:text-3xl font-bold mb-2" x-text="promo.name"></h3>
                                        <p class="text-white/80 text-sm md:text-base font-light line-clamp-2" x-text="promo.description || 'Nikmati potongan harga spesial untuk perjalanan Anda.'"></p>
                                        <div class="flex items-center gap-4 mt-4 text-sm text-white/60">
            ...
            <div class="flex justify-between items-center mt-4 text-xs text-gray-400 font-mono uppercase tracking-wider">
                ...
                <span x-show="!isPlaying" class="flex items-center gap-1.5 text-gray-500">
