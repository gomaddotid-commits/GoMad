            ...
            <div class="lg:col-span-1">
                <div class="card-gomad p-5 sticky top-24 border-[#E5E7EB]">
                    <div class="flex items-center justify-between mb-4 border-b border-[#E5E7EB] pb-3">
                        ...
                        <a href="{{ route('search') }}" class="text-xs text-[#BA1826] hover:underline font-medium">Reset</a>
                        @endif
                    </div>
                    ...
                    <form action="{{ route('search') }}" method="GET" class="space-y-4">
                        <div>
                            ...
                            <select name="origin" class="w-full px-3 py-2 border-b-2 border-[#E5E7EB] focus:border-[#BA1826] outline-none bg-transparent font-medium text-[#111827] appearance-none cursor-pointer">
                        ...
                        <div>
                            ...
                            <select name="destination" class="w-full px-3 py-2 border-b-2 border-[#E5E7EB] focus:border-[#BA1826] outline-none bg-transparent font-medium text-[#111827] appearance-none cursor-pointer">
                                <option value="">Semua Kota</option>
                                @foreach($allCities as $city)
                        ...
                        <div>
                            ...
                            <input type="date" name="date" value="{{ request('date') }}" 
                                   class="w-full px-3 py-2 border-b-2 border-[#E5E7EB] focus:border-[#BA1826] outline-none bg-transparent font-medium text-[#111827] cursor-pointer">
                        </div>
                        <div>
                            <label class="block text-xs font-mono uppercase tracking-wider text-gray-500 mb-1">Kelas</label>
                            <select name="travel_class" class="w-full px-3 py-2 border-b-2 border-[#E5E7EB] focus:border-[#BA1826] outline-none bg-transparent font-medium text-[#111827] appearance-none cursor-pointer">
                        ...
                        <div>
                            ...
                            <select name="agency_id" class="w-full px-3 py-2 border-b-2 border-[#E5E7EB] focus:border-[#BA1826] outline-none bg-transparent font-medium text-[#111827] appearance-none cursor-pointer">
                            ...
                            <div class="flex justify-between items-center border-t border-[#E5E7EB] pt-3">
                                ...
                                @auth
                                    ...
                                    <a href="{{ route('customer.booking.create', $schedule) }}" 
                                       class="btn-gomad-primary text-sm py-2 px-4 rounded-[10px]">Booking</a>
                                    @endif
                                @else
                                    <a href="{{ route('login') }}" 
                                       class="btn-gomad-outline text-sm py-2 px-4 rounded-[10px] border-[#BA1826] text-[#BA1826] hover:bg-[#BA1826] hover:text-white">Login</a>
                                @endauth
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="card-gomad p-5 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 group border-[#E5E7EB] hover:border-[#BA1826]">
                            ...
                            <div class="flex items-center gap-4 flex-shrink-0">
                                ...
                                @auth
                                    @if($schedule->available_seats > 0)
                                    <a href="{{ route('customer.booking.create', $schedule) }}" 
                                       class="btn-gomad-primary text-sm py-2 px-5 rounded-[10px] whitespace-nowrap">Booking</a>
                                    @endif
                                @else
                                    <a href="{{ route('login') }}" 
                                       class="btn-gomad-outline text-sm py-2 px-5 rounded-[10px] whitespace-nowrap border-[#BA1826] text-[#BA1826] hover:bg-[#BA1826] hover:text-white">Login</a>
                                @endauth
                            </div>
                        </div>
                        @endforeach
